...
#include "private/backend/DriverAPI.inc"
    ...
    backend::FrameScheduledCallback sched_callback_ = nullptr;
    void* sched_user_ = nullptr;
    backend::FrameCompletedCallback compl_callback_ = nullptr;
    void* compl_user_ = nullptr;
    void callScheduedCallback(const char *action, void *a1, void* a2, void *a3);
    void callCompletedCallback(const char *action, void *a1, void* a2, void *a3);
};
