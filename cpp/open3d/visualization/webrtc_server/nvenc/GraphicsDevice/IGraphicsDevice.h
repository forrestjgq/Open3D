...
#include "open3d/visualization/webrtc_server/nvenc/GraphicsDevice/GraphicsDeviceType.h"

#if CUDA_PLATFORM
#include "open3d/visualization/webrtc_server/nvenc/GraphicsDevice/Cuda/ICudaDevice.h"
#endif
